...
import org.apache.xml.crypto.dsig.spec.*;
...
public class DOMUtils {
                                       ...
                                       XSLTTransformParameterSpec spec2)
    {
        ...
        if (!(ostylesheet instanceof org.apache.xml.crypto.dom.DOMStructure)) {
            return false;
        }
        Node ostylesheetElem =
            ((org.apache.xml.crypto.dom.DOMStructure) ostylesheet).getNode();
        XMLStructure stylesheet = spec1.getStylesheet();        
        Node stylesheetElem =
            ((org.apache.xml.crypto.dom.DOMStructure) stylesheet).getNode();
