...
import org.apache.xml.crypto.dom.*;
...
public final class DOMKeyInfo extends DOMStructure implements KeyInfo {
        ...
        throws MarshalException
    {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (localName.equals("X509Data")) {
                ...
                content.add(new org.apache.xml.crypto.dom.DOMStructure((childElem)));
            }
        }
        ...
        throws MarshalException
    {
        ...
        Node pNode = ((org.apache.xml.crypto.dom.DOMStructure)parent).getNode();
        ...
        for (XMLStructure kiType : keyInfoTypes) {
            if (kiType instanceof DOMStructure) {
                ...
                DOMUtils.appendChild(kiElem,
                    ((org.apache.xml.crypto.dom.DOMStructure)kiType).getNode());
            }
        }
