...
import es.gob.afirma.xml.crypto.dsig.keyinfo.PGPData;
...
public final class DOMPGPData extends DOMStructure implements PGPData {
            ...
            if (n.getNodeType() == Node.ELEMENT_NODE) {
                ...
                try {
                    if (localName.equals("PGPKeyID")) {
                        ...
                        other.add
                            (new es.gob.afirma.xml.crypto.dom.DOMStructure(childElem));
                    }
        ...
        throws MarshalException
    {
        ...
        for (XMLStructure extElem : externalElements) {
            DOMUtils.appendChild(pdElem, ((es.gob.afirma.xml.crypto.dom.DOMStructure) 
                extElem).getNode());
        }
