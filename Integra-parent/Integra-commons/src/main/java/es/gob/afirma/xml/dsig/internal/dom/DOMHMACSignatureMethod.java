 ...
 */
/*
 * $Id: DOMHMACSignatureMethod.java 1197150 2011-11-03 14:34:57Z coheigea $
 */
...
import es.gob.afirma.xml.crypto.dsig.spec.HMACParameterSpec;
import es.gob.afirma.xml.crypto.dsig.spec.SignatureMethodParameterSpec;

import org.w3c.dom.Document;
import org.w3c.dom.Element;

import es.gob.afirma.xml.dsig.internal.MacOutputStream;
...
public abstract class DOMHMACSignatureMethod extends AbstractDOMSignatureMethod {
    ...
    private static org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory.getLog(DOMHMACSignatureMethod.class);

    // see RFC 4051 for these algorithm definitions
    final static String HMAC_SHA256 = "http://www.w3.org/2001/04/xmldsig-more#hmac-sha256";
    final static String HMAC_SHA384 = "http://www.w3.org/2001/04/xmldsig-more#hmac-sha384";
    final static String HMAC_SHA512 = "http://www.w3.org/2001/04/xmldsig-more#hmac-sha512";
