 ...
 * under the License.
 */
package es.gob.afirma.xml.security.encryption;
...
import es.gob.afirma.xml.security.algorithms.JCEMapper;
import es.gob.afirma.xml.security.algorithms.MessageDigestAlgorithm;
...
import es.gob.afirma.xml.security.keys.keyresolver.implementations.EncryptedKeyResolver;
import es.gob.afirma.xml.security.signature.XMLSignatureException;
import es.gob.afirma.xml.security.transforms.InvalidTransformException;
import es.gob.afirma.xml.security.transforms.TransformationException;
import es.gob.afirma.xml.security.utils.Base64;
import es.gob.afirma.xml.security.utils.Constants;
import es.gob.afirma.xml.security.utils.ElementProxy;
...
public class XMLCipher {
    ...
    public static final String BASE64_ENCODING =             
        es.gob.afirma.xml.security.transforms.Transforms.TRANSFORM_BASE64_DECODE;
    ...
    private class Factory {
        ...
        private class TransformsImpl extends es.gob.afirma.xml.security.transforms.Transforms 
            ...
            /** @inheritDoc */
            public es.gob.afirma.xml.security.transforms.Transforms getDSTransforms() {
                return this;
            }
