 ...
 */
/*
 * $Id: DOMReference.java 1231033 2012-01-13 12:12:12Z coheigea $
 */
...
import es.gob.afirma.xml.crypto.Data;
import es.gob.afirma.xml.crypto.MarshalException;
import es.gob.afirma.xml.crypto.NodeSetData;
import es.gob.afirma.xml.crypto.OctetStreamData;
import es.gob.afirma.xml.crypto.URIDereferencer;
import es.gob.afirma.xml.crypto.URIReferenceException;
import es.gob.afirma.xml.crypto.XMLCryptoContext;
import es.gob.afirma.xml.crypto.dom.DOMCryptoContext;
import es.gob.afirma.xml.crypto.dom.DOMURIReference;
...
import es.gob.afirma.xml.crypto.dsig.TransformService;
...
import es.gob.afirma.xml.dsig.internal.DigesterOutputStream;
...
import es.gob.afirma.xml.security.utils.UnsyncBufferedOutputStream;
    ...
    */
        ...
        throws XMLSignatureException
    {
        ...
        Boolean cache = (Boolean)
            context.getProperty("es.gob.afirma.xml.crypto.dsig.cacheReference");
