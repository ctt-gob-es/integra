...
public interface ISignPolicyConstants {
    ...
    /**
     *  Constant attribute that identifies the key defined on properties file with the identifier of the signature policy
    ...
    /**
     *  Constant attribute that identifies the fixed part of the key defined on properties file with the ID of the signature
    ...
    /**
     *  Constant attribute that identifies the fixed part of the key defined on properties file with the path of the document
     *  with the hash value of the signature policy.
     */
    String KEY_HASH_VALUE = "-HASH_VALUE";

    /**
     *  Constant attribute that identifies the fixed part of the key defined on properties file with the description of the
     *  signature policy.
     */
    String KEY_DESCRIPTION = "-DESCRIPTION";

    /**
     *  Constant attribute that identifies the fixed part of the key defined on properties file with the hash algorithm
     *  used for generating the digest of the document of the signature policy.
     */
    String KEY_HASH_ALGORITHM = "-HASH_ALGORITHM";

    /**
     *  Constant attribute that identifies the fixed part of the key defined on properties file with the allowed hash
     *  algorithms for XML signatures.
     */
    String KEY_XML_HASH = "XML_HASH-";

    /**
     *  Constant attribute that identifies the fixed part of the key defined on properties file with the allowed sign
     *  algorithms for XML signatures.
     */
    String KEY_XML_SIGN_HASH = "XML_SIGN_HASH-";

    /**
     *  Constant attribute that identifies the fixed part of the key defined on properties file with the list of allowed
     *  hash algorithms.
     */
    ...
    /**
     *  Constant attribute that identifies the fixed part of the key defined on properties file with the list of required
     *  signed elements defined by the signature policy.
     */
    String KEY_MANDATORY_SIGNED_ELEMENTS = "-MANDATORY_SIGNED_ELEMENTS";

    /**
     *  Constant attribute that identifies the fixed part of the key defined on properties file with the list of optional
     *  signed elements defined by the signature policy.
     */
    ...
    /**
     *  Constant attribute that identifies the fixed part of the key defined on properties file with the list of signed 
    ...
    /**
     *  Constant attribute that identifies the fixed part of the key defined on properties file with the list of unsigned 
     *  elements that shall not be used, defined by the signature policy.
     */
    ...
    /**
     *  Constant attribute that identifies the fixed part of the key defined on properties file with the list of 
    ...
    /**
     *  Constant attribute that identifies the fixed part of the key defined on properties file with the list of not allowed 
     *  entries, defined by the signature policy.
     */
    ...
    /**
     * Constant attribute that identifies the AND operator for the values defined on properties file. 
     */
    String OPERATOR_AND = ",";

    /**
     * Constant attribute that identifies the OR operator for the values defined on properties file. 
     */
    String OPERATOR_OR = "|";
