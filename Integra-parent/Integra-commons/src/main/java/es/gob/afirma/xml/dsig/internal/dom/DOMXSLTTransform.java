...
import es.gob.afirma.xml.crypto.dsig.spec.XSLTTransformParameterSpec;
...
public final class DOMXSLTTransform extends ApacheTransform {
    ...
    private void unmarshalParams(Element sheet) {
        this.params = new XSLTTransformParameterSpec
            (new es.gob.afirma.xml.crypto.dom.DOMStructure(sheet));
    }
    ...
    public void marshalParams(XMLStructure parent, XMLCryptoContext context)
        ...
        Node xsltElem = 
            ((es.gob.afirma.xml.crypto.dom.DOMStructure) xp.getStylesheet()).getNode();
