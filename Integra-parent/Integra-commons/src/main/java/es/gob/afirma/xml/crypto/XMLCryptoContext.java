 ...
 */
package es.gob.afirma.xml.crypto;
 ...
 * {@link es.gob.afirma.xml.crypto.dsig.XMLValidateContext} instance to validate two 
 * different {@link es.gob.afirma.xml.crypto.dsig.XMLSignature} objects). 
 *
 * @author Sean Mullan
