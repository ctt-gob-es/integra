 ...
 */
/*
 * $Id: DOMSignatureMethod.java 1197150 2011-11-03 14:34:57Z coheigea $
 */
package es.gob.afirma.xml.dsig.internal.dom;
...
import es.gob.afirma.xml.crypto.dsig.XMLSignContext;
import es.gob.afirma.xml.crypto.dsig.XMLSignatureException;
import es.gob.afirma.xml.crypto.dsig.XMLValidateContext;
import es.gob.afirma.xml.crypto.dsig.spec.SignatureMethodParameterSpec;

import org.w3c.dom.Element;

import es.gob.afirma.xml.dsig.internal.SignerOutputStream;
import es.gob.afirma.xml.security.algorithms.implementations.SignatureECDSA;
...
public abstract class DOMSignatureMethod extends AbstractDOMSignatureMethod {
    ...
    private static org.apache.commons.logging.Log log = org.apache.commons.logging.LogFactory.getLog(DOMSignatureMethod.class);
    ...
    final static String RSA_SHA384 = "http://www.w3.org/2001/04/xmldsig-more#rsa-sha384";
    final static String RSA_SHA512 = "http://www.w3.org/2001/04/xmldsig-more#rsa-sha512";
    final static String ECDSA_SHA1 = "http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha1";
    final static String ECDSA_SHA256 = "http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha256";
    final static String ECDSA_SHA384 = "http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha384";
    final static String ECDSA_SHA512 = "http://www.w3.org/2001/04/xmldsig-more#ecdsa-sha512";
