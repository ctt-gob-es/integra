 ...
 */
/*
 * $Id: DOMSignatureProperty.java 1231033 2012-01-13 12:12:12Z coheigea $
 */
...
public final class DOMSignatureProperty extends DOMStructure 
        ...
        throws MarshalException
    {
        ...
        for (int i = 0; i < length; i++) {
            content.add(new es.gob.afirma.xml.crypto.dom.DOMStructure(nodes.item(i)));
        }
        if (content.isEmpty()) {
        ...
        throws MarshalException
    {
        ...
        for (XMLStructure property : content) {
            DOMUtils.appendChild(propElem,
                ((es.gob.afirma.xml.crypto.dom.DOMStructure)property).getNode());
        }
