 ...
 */
/*
 * $Id: DOMKeyInfo.java 1231033 2012-01-13 12:12:12Z coheigea $
 */
...
import es.gob.afirma.xml.crypto.dom.*;
...
public final class DOMKeyInfo extends DOMStructure implements KeyInfo {
        ...
        throws MarshalException
    {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (localName.equals("X509Data")) {
                ...
                content.add(new es.gob.afirma.xml.crypto.dom.DOMStructure((childElem)));
            }
        }
        ...
        throws MarshalException
    {
        ...
        Node pNode = ((es.gob.afirma.xml.crypto.dom.DOMStructure)parent).getNode();
        ...
        for (XMLStructure kiType : keyInfoTypes) {
            if (kiType instanceof DOMStructure) {
                ...
                DOMUtils.appendChild(kiElem,
                    ((es.gob.afirma.xml.crypto.dom.DOMStructure)kiType).getNode());
            }
        }
