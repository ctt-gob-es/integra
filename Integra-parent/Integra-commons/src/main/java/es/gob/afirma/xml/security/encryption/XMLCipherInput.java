...
public class XMLCipherInput {
    ...
    private static org.apache.commons.logging.Log logger = org.apache.commons.logging.LogFactory.getLog(XMLCipherInput.class);
	...
	if (cipherData.getDataType() == CipherData.REFERENCE_TYPE) {
		...
		try {
		    es.gob.afirma.xml.security.transforms.Transforms dsTransforms = transforms.getDSTransforms();
