...
/**
 * <b>File:</b><p>es.gob.afirma.integraFacade.pojo.BatchVerifyCertificateResponse.java.</p>
 * <b>Description:</b><p>Class that represents the response from the verify certificates on batch service.</p>
...
/**
 * <p>Class that represents the response from the verify certificates on batch service.</p>
 * <b>Project:</b><p>Library for the integration with the services of @Firma, eVisor and TS@.</p>
 * @version 1.0, 24/11/2014.
 */
public class BatchVerifyCertificateResponse implements Serializable {

    /**
     * Class serial version.
     */
    private static final long serialVersionUID = -3452880496219222800L;
    ...
    /**
     * Attribute that contains the set of individual response to validate certificate.
     */
    private List<VerifyCertificateResponse> listVerifyResponse;

    /**
     * Constructor method for the class BatchVerifyCertificateResponse.java.
     */
     ...
     */
    public final void setListVerifyResponse(List<VerifyCertificateResponse> listVerifyResponseParam) {
