 ...
 */
/*
 * $Id: DOMUtils.java 1231033 2012-01-13 12:12:12Z coheigea $
 */
...
import es.gob.afirma.xml.crypto.dsig.spec.*;
...
public class DOMUtils {
                                       ...
                                       XSLTTransformParameterSpec spec2)
    {
        ...
        if (!(ostylesheet instanceof es.gob.afirma.xml.crypto.dom.DOMStructure)) {
            return false;
        }
        Node ostylesheetElem =
            ((es.gob.afirma.xml.crypto.dom.DOMStructure) ostylesheet).getNode();
        XMLStructure stylesheet = spec1.getStylesheet();        
        Node stylesheetElem =
            ((es.gob.afirma.xml.crypto.dom.DOMStructure) stylesheet).getNode();
