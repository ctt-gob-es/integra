 ...
 */
/*
 * $Id: DOMTransform.java 1214814 2011-12-15 15:47:21Z coheigea $
 */
...
public class DOMTransform extends DOMStructure implements Transform {
        ...
        throws MarshalException
    {
        ...
        try {
            spi.init(new es.gob.afirma.xml.crypto.dom.DOMStructure(transElem), context);
        ...
        throws MarshalException
    {
        ...
        spi.marshalParams(new es.gob.afirma.xml.crypto.dom.DOMStructure(transformElem),
                          context);
