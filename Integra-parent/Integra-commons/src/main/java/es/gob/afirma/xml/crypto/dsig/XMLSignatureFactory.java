 ...
 */
package es.gob.afirma.xml.crypto.dsig;
...
import es.gob.afirma.xml.crypto.NoSuchMechanismException;
...
import es.gob.afirma.xml.crypto.dsig.spec.DigestMethodParameterSpec;
 ...
 * es.gob.afirma.xml.crypto.dsig.dom.DOMValidateContext} objects.
 * 
...
public abstract class XMLSignatureFactory {
	...
	Provider.Service ps = provider.getService("XMLSignatureFactory", mechanismType);
	if (ps == null) {
