...
/**
 * <b>File:</b><p>es.gob.afirma.signature.validation.PDFSignatureDictionaryValidationResult.java.</p>
 * <b>Description:</b><p>Class that contains all the information related to the result of a signature dictionary validation process for a PDF document.</p>
...
/**
 * <p>Class that contains all the information related to the result of a signature dictionary validation process for a PDF document.</p>
 * <b>Project:</b><p>Library for the integration with the services of @Firma, eVisor and TS@.</p>
 * @version 1.2, 14/03/2017.
 */
public class PDFSignatureDictionaryValidationResult implements Serializable {

    /**
     * Class serial version.
     */
    private static final long serialVersionUID = 4464223804735848673L;
