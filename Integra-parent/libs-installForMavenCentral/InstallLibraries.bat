...
rem #Dependencia con Lowagie IText 2.2.
call mvn install:install-file -Dfile=./es/gob/afirma/lib/itext-afirma/2.6/itext-afirma-2.6.jar -DgroupId=es.gob.afirma.lib -DartifactId=itext-afirma -Dversion=2.6 -Dpackaging=jar
