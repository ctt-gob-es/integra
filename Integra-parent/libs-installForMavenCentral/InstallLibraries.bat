...
rem #Dependencia con Lowagie IText 2.2.
call mvn install:install-file -Dfile=./es/gob/afirma/lib/itext-afirma/2.4/itext-afirma-2.4.jar -DgroupId=es.gob.afirma.lib -DartifactId=itext-afirma -Dversion=2.4 -Dpackaging=jar
