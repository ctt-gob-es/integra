...
/**
 * <b>File:</b><p>es.gob.afirma.afirma5ServiceInvoker.ws.Afirma5WebServiceInvoker.java.</p>
 ...
 * @version 1.0, 26/12/2014.
 */
public class Afirma5WebServiceInvoker extends AbstractWSServiceInvoker {
     ...
     */
    public Afirma5WebServiceInvoker(String applicationName, String service, String idClient) {
	super(applicationName, service, idClient, false);
    }
