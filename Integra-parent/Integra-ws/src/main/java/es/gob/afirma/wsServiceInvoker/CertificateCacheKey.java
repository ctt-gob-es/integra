...
public class CertificateCacheKey {
     ...
     * <ul>
     * <li>{@link es.gob.afirma.utils.GeneralConstants#DSS_AFIRMA_VERIFY_CERTIFICATE_REQUEST}</li>
     * <li>{@link es.gob.afirma.utils.GeneralConstants#CERTIFICATE_VALIDATION_REQUEST}</li>
     * <li>{@link es.gob.afirma.utils.GeneralConstants#VALIDACION_CERTIFICADO_REQUEST}</li>
     * </ul>
     */
