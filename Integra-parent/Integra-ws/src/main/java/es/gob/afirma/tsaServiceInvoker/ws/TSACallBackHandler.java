...
public class TSACallBackHandler implements CallbackHandler {
     ...
     */
    private static final Logger LOGGER = IntegraLogger.getInstance().getLogger(TSACallBackHandler.class);
	...
	if (certificateSOAPResponse != null) {
	    ...
	    String canonicalizedIssuerNameReq = UtilsCertificateCommons.canonicalizeX500Principal(issuerNameReq);
	...
	public final boolean validate(X509Certificate certificate) throws CertificateValidationException {
		...
		if (certificateSOAPResponse != null) {
		    ...
		    // respuesta SOAP
		    String issuerDNSOAPResponse = UtilsCertificateCommons.canonicalizeX500Principal(certificate.getIssuerDN().getName());
		    ...
		    // las
		    // respuestas SOAP
		    String issuerDN = UtilsCertificateCommons.canonicalizeX500Principal(certificateSOAPResponse.getIssuerDN().getName());
