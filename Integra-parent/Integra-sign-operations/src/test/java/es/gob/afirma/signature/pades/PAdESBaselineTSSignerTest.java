 ...
 * <b>Description:</b><p>Class that defines tests for {@link PAdESBaselineTSSigner}.</p>
...
/**
 * <p>Class that defines tests for {@link PAdESBaselineTSSigner}.</p>
 * <b>Project:</b><p>Library for the integration with the services of @Firma, eVisor and TS@.</p>
 * @version 1.2, 14/03/2017.
 */
public class PAdESBaselineTSSignerTest extends AbstractSignatureTest {
    ...
    /**
     * Test for methods {@link PAdESBaselineTSSigner#sign(byte[], String, String, PrivateKeyEntry, java.util.Properties, boolean, String, String)},
     * and {@link PAdESBaselineTSSigner#verifySignature(byte[])}.
     */
	...
	PAdESBaselineTSSigner signer = new PAdESBaselineTSSigner();
    ...
    /**
     * Test for method {@link PAdESBaselineTSSigner#getSignedData(byte[])}.
     */
