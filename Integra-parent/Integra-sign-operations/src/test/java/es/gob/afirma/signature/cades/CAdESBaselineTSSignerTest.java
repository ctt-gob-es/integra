 ...
 * <b>Description:</b><p>Class that defines tests for {@link CAdESBaselineTSSigner}.</p>
...
/**
 * <p>Class that defines tests for {@link CAdESBaselineTSSigner}.</p>
 * <b>Project:</b><p>Library for the integration with the services of @Firma, eVisor and TS@.</p>
 * @version 1.3, 06/03/2020.
 */
public class CAdESBaselineTSSignerTest extends TestCase {
    ...
    /**
     * Test for methods {@link CAdESBaselineTSSigner#sign(byte[], String, String, PrivateKeyEntry, java.util.Properties, boolean, String, String)},
     * {@link CAdESBaselineTSSigner#coSign(byte[], byte[], String, PrivateKeyEntry, java.util.Properties, boolean, String, String)},
     * {@link CAdESBaselineTSSigner#counterSign(byte[], String, PrivateKeyEntry, java.util.Properties, boolean, String, String)},
     * and {@link CAdESBaselineTSSigner#verifySignature(byte[], byte[])}.
     */
	...
	CAdESBaselineTSSigner signer = new CAdESBaselineTSSigner();
	...
	*/
    ...
    /**
        * Test for methods {@link CAdESBaselineTSSigner#getSignedData(byte[])}.
        */
	...
	CAdESBaselineTSSigner csb = new CAdESBaselineTSSigner();
