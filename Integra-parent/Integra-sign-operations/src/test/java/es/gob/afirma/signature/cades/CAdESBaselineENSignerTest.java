 ...
 * <b>Description:</b><p>Class that defines tests for {@link CAdESBaselineENSigner}.</p>
...
/**
 * <p>Class that defines tests for {@link CAdESBaselineENSigner}.</p>
 * <b>Project:</b><p>Library for the integration with the services of @Firma, eVisor and TS@.</p>
 * @version 1.3, 06/03/2020.
 */
public class CAdESBaselineENSignerTest extends TestCase {
    ...
    /**
     * Test for methods {@link CAdESBaselineENSigner#sign(byte[], String, String, PrivateKeyEntry, java.util.Properties, boolean, String, String)},
     * {@link CAdESBaselineENSigner#coSign(byte[], byte[], String, PrivateKeyEntry, java.util.Properties, boolean, String, String)},
     * {@link CAdESBaselineENSigner#counterSign(byte[], String, PrivateKeyEntry, java.util.Properties, boolean, String, String)},
     * and {@link CAdESBaselineENSigner#verifySignature(byte[], byte[])}.
     */
	...
	CAdESBaselineENSigner signer = new CAdESBaselineENSigner();
	...
	try {
	    ...
	    try (FileOutputStream fos = new FileOutputStream("C:\\Users\\carlos.gamuci\\Desktop\\cades_counter.csig")) {
		fos.write(cadesBLevelCounterSignature);
	    }
	    catch (Exception e) {
	...
	*/
    ...
    /**
        * Test for methods {@link CAdESBaselineENSigner#getSignedData(byte[])}.
        */
	...
	CAdESBaselineENSigner csb = new CAdESBaselineENSigner();
    ...
    /**
     * Test for methods {@link CAdESBaselineENSigner#verifySignature(byte[], byte[])}.
     */
    public final void testVerifySignatureBBLevelWitRoles() {

	// Se obtiene firma CAdES B-B-Level con PolicyStore
	byte[ ] signature = UtilsFileSystemCommons.readFile("signatures/CAdES_BBLevel_con_roles.csig", true);
	CAdESBaselineENSigner signer = new CAdESBaselineENSigner();
	ValidationResult result = signer.verifySignature(signature, null);
	...
	// Se obtiene firma CAdES B-B-Level con PolicyStore
	byte[ ] signature = UtilsFileSystemCommons.readFile("signatures/CAdES_BBLevel_PolicyStore_OK.csig", true);
	CAdESBaselineENSigner signer = new CAdESBaselineENSigner();
	ValidationResult result = signer.verifySignature(signature, null);
	assertTrue(result.isCorrect());
    }
     ...
     * Test for methods {@link CAdESBaselineENSigner#verifySignature(byte[], byte[])}.
     */
    public final void testVerifySignatureWithPolicyStore() {
    ...
    @Test
    public void testVerifySignatureWithSignatureStoreWithWrongDocument() {

	byte[ ] signature = UtilsFileSystemCommons.readFile("signatures/CAdES_BBLevel_PolicyStore_WrongDocument.csig", true);
	CAdESBaselineENSigner signer = new CAdESBaselineENSigner();
	ValidationResult vr = signer.verifySignature(signature, null);
	assertFalse(vr.isCorrect());
	System.out.println(vr.getErrorMsg());
    }
    
    @Test
    public void testVerifySignatureWithSignatureStoreWithWrongId() {

	byte[ ] signature = UtilsFileSystemCommons.readFile("signatures/CAdES_BBLevel_PolicyStore_WrongId.csig", true);
	CAdESBaselineENSigner signer = new CAdESBaselineENSigner();
	ValidationResult vr = signer.verifySignature(signature, null);
	assertFalse(vr.isCorrect());
	System.out.println(vr.getErrorMsg());
    ...
    @Test
    public void testVerifySignatureWithSignatureStoreWithLocalUri() {

	byte[ ] signature = UtilsFileSystemCommons.readFile("signatures/CAdES_BBLevel_PolicyStore_WithLocalUri.csig", true);
	CAdESBaselineENSigner signer = new CAdESBaselineENSigner();
	ValidationResult vr = signer.verifySignature(signature, null);
	assertFalse(vr.isCorrect());
    }
