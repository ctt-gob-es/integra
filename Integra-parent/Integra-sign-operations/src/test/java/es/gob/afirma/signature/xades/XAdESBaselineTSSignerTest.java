 ...
 * <b>Description:</b><p>Class that defines tests for {@link XAdESBaselineTSSigner}.</p>
...
/**
 * <p>Class that defines tests for {@link XAdESBaselineTSSigner}.</p>
 * <b>Project:</b><p>Library for the integration with the services of @Firma, eVisor and TS@.</p>
 * @version 1.3, 16/04/2020.
 */
public class XAdESBaselineTSSignerTest extends TestCase {
    ...
    /**
     * Test for methods {@link XAdESBaselineTSSigner#sign(byte[], String, String, PrivateKeyEntry, java.util.Properties, boolean, String, String)},
     * {@link XAdESBaselineTSSigner#coSign(byte[], byte[], String, PrivateKeyEntry, java.util.Properties, boolean, String, String)},
     * {@link XAdESBaselineTSSigner#counterSign(byte[], String, PrivateKeyEntry, java.util.Properties, boolean, String, String)},
     * and {@link XAdESBaselineTSSigner#verifySignature(byte[])}.
     */
	...
	XAdESBaselineTSSigner signer = new XAdESBaselineTSSigner();
	...
	try {
	    ...
	    try (FileOutputStream fos = new FileOutputStream("C:\\Users\\carlos.gamuci\\Desktop\\xades_sin_keyinfo.xml")) {
		fos.write(xadesBLevelSignature);
	    }
	    catch (Exception e) {
    ...
    /**
     * Test for methods {@link XAdESBaselineTSSigner#getSignedData(byte[])}.
     */
