 ...
 * @version 1.3, 13/04/2020.
 */
public final class PAdESBaselineTSSigner implements Signer {

    /**
     * Attribute that represents the object that manages the log of the class.
     */
    private static final Logger LOGGER = IntegraLogger.getInstance().getLogger(PAdESBaselineTSSigner.class);

    /**
     * Constructor method for the class PAdESBaselineSigner.java.
     */
    public PAdESBaselineTSSigner() {
