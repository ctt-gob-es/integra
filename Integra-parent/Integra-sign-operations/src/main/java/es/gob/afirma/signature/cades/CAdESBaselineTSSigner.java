 ...
 * @version 1.7, 13/04/2020.
 */
public final class CAdESBaselineTSSigner implements Signer {

    /**
     *  Attribute that represents the object that manages the log of the class.
     */
    private static final Logger LOGGER = IntegraLogger.getInstance().getLogger(CAdESBaselineTSSigner.class);
