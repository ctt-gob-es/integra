...
/**
 * <p>Class that manages the generation, validation and upgrade of XAdES Baseline signatures
 * according ETSI Technical Specification (ETSI TS 103 171).</p>
 * <b>Project:</b><p>Library for the integration with the services of @Firma, eVisor and TS@.</p>
 * @version 1.9, 16/04/2020.
 */
public final class XAdESBaselineTSSigner implements Signer {

    /**
     * Attribute that represents the object that manages the log of the class.
     */
    private static final Logger LOGGER = IntegraLogger.getInstance().getLogger(XAdESBaselineTSSigner.class);
	...
	LOGGER.info(Language.getResIntegra(ILogConstantKeys.XBS_LOG002));
	try {
	    return generateXAdESSignature(data, algorithm, signatureFormat, privateKey, extraParams, includeTimestamp, signatureForm, signaturePolicyID, null, asicsSignature, signedFileName);
	} catch (UnsupportedEncodingException e) {
	    String errorMsg = Language.getResIntegra(ILogConstantKeys.XBS_LOG036);
	    LOGGER.error(errorMsg, e);
	    throw new SigningException(errorMsg, e);
