 ...
 * <b>Description:</b><p> Class that represents the response object for evisor generate report service.</p>
...
/** 
 * <p>Class that represents the response object for evisor generate report service.</p>
 * <b>Project:</b><p>Library for the integration with the services of @Firma, eVisor and TS@.</p>
 * @version 1.0, 12/5/2016.
 */
public class ResponseEvisorGenerateReport {
    ...
    /**
     * Attribute that represents eVisor response result. 
     */
    private EvisorResult result;

    /**
     * Attribute that represents the report generated by eVisor. 
     */
    private byte[ ] report;
     ...
     */
    public ResponseEvisorGenerateReport() {
	super();
    }
