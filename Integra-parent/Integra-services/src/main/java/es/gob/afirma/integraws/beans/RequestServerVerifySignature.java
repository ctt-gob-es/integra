...
/** 
 * <b>File:</b><p>es.gob.afirma.integraws.beans.RequestServerVerifySignature.java.</p>
 * <b>Description:</b><p> Class that represents the request object for SERVERVERIFYSIGNATURE service.</p>
...
/** 
 * <p>Class that represents the request object for SERVERVERIFYSIGNATURE service.</p>
 * <b>Project:</b><p>Library for the integration with the services of @Firma, eVisor and TS@.</p>
 * @version 1.0, 12/5/2016.
 */
public class RequestServerVerifySignature extends VerifySignatureRequest{
    
    /**
     * Attribute that represents serialVersionUID. 
     */
    private static final long serialVersionUID = -631012843975417213L;
    ...
    /**
     * Constructor method for the class RequestServerVerifySignature.java. 
     */
    public RequestServerVerifySignature(){
	super();
    }
