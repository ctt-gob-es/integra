...
/** 
 * <b>File:</b><p>es.gob.afirma.integraws.beans.RequestServerBatchVerifyCertificate.java.</p>
 * <b>Description:</b><p> Class that represents the request object for BATCHVERIFYCERTIFICATE service.</p>
...
/** 
 * <p>Class that represents the request object for BATCHVERIFYCERTIFICATE service.</p>
 * <b>Project:</b><p>Library for the integration with the services of @Firma, eVisor and TS@.</p>
 * @version 1.0, 12/5/2016.
 */
public class RequestServerBatchVerifyCertificate extends BatchVerifyCertificateRequest{
    
    /**
     * Attribute that represents serialVersionUID. 
     */
    private static final long serialVersionUID = 6275674852078673747L;
    ...
    /**
     * Constructor method for the class RequestServerBatchVerifyCertificate.java. 
     */
    public RequestServerBatchVerifyCertificate(){
	super();
    }
