...
/** 
 * <b>File:</b><p>es.gob.afirma.integraws.beans.ResponseServerVerifyCertificate.java.</p>
 * <b>Description:</b><p> Class that represents the response object for server verify certificate service.</p>
...
/** 
 * <p>Class that represents the response object for server verify certificate service.</p>
 * <b>Project:</b><p>Library for the integration with the services of @Firma, eVisor and TS@.</p>
 * @version 1.0, 12/5/2016.
 */
public class ResponseServerVerifyCertificate extends VerifyCertificateResponse{
    
    /**
     * Attribute that represents serialVersionUID. 
     */
    private static final long serialVersionUID = 2120106805873630185L;
     ...
     */
    public ResponseServerVerifyCertificate() {
	super();
    }
	...
	this.setCertificatePathValidity(certificatePathValidityParam);
	this.setReadableCertificateInfo(readableCertificateInfoParam);
