...
/** 
 * <b>File:</b><p>es.gob.afirma.integraws.beans.ResponseServerBatchVerifyCertificate.java.</p>
 * <b>Description:</b><p> Class that represents the response object for server batch verify certificate service.</p>
...
/** 
 * <p>Class that represents the response object for server batch verify certificate service.</p>
 * <b>Project:</b><p>Library for the integration with the services of @Firma, eVisor and TS@.</p>
 * @version 1.0, 12/5/2016.
 */
public class ResponseServerBatchVerifyCertificate extends BatchVerifyCertificateResponse{
    
    /**
     * Attribute that represents serialVersionUID. 
     */
    private static final long serialVersionUID = 1506198122110644269L;
     ...
     */
    public ResponseServerBatchVerifyCertificate() {
	super();
    }
