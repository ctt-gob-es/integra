...
/**
 * <p>
 * Class to manage the connection to the HSM and create the Keystore
 * representation.
 * </p>
 * <b>Project:</b>
 * <p>
...
public final class HSMKeystorePKCS11Provider {
	 ...
	 * 
	 * @throws HSMException In case of some error loading the properties or the HSM
	 *                      configuration.
	 */
		...
		try {
			try {
				...
				if (pkcs11Provider == null) {
					String pathCfg = System.getProperty("integra.config") + File.separator + IHSMConstants.HSM_CFG;
					Provider p = Security.getProvider("SunPKCS11");
					pkcs11Provider = p.configure(pathCfg);
			...
			try {
				// El keystore lo cargaremos sin password. Si el keystore del hsm trae password tendríamos que incorporar la password de dicho hsm.
