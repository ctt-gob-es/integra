...
public final class Language {
     ...
     */
    private static final String BUNDLENAME_INTEGRA = "sigreport";
	...
	if (urlClassLoaderMessages != null) {
		...
		if (System.getProperty("integra.config") != null) {
		    try {
			url = new File(System.getProperty("integra.config") + File.separator + BUNDLENAME_LANGUAGE + ".properties").toURI().toURL();
		    } catch (MalformedURLException e) {
     ...
     */
    public static String getResSigReport(String key) {
     ...
     */
    public static String getFormatResSigReport(String key, Object[ ] values) {
