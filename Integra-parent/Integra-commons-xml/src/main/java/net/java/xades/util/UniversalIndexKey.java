...
public class UniversalIndexKey implements Comparable<UniversalIndexKey> {
	...
	// System.out.println("compareTo: indexKeys.size(): " + indexKeys.size()
	// + ", other.indexKeys.size(): " + other.indexKeys.size());
	...
	for (int i = 0; i < size; i++) {
		...
		// System.out.println((i + 1) + ". " + firstComparable + " ? " +
		// secondComparable + " = " + compareResult);
		if (compareResult != 0)
	...
	// System.out.println("equals: indexKeys.size(): " + indexKeys.size() +
	// ", other.indexKeys.size(): " + other.indexKeys.size());
