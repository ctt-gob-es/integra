...
public class SignedSignatureProperties extends XAdESStructure {
	...
	if (signingCertificate != null) {
	    new SigningCertificateDetails(this, signingCertificate, xadesPrefix, xadesNamespace, xmlSignaturePrefix);
	}
    }
	...
	if (signerRole != null) {
		...
		new SignerRoleDetails(this, signerRole, xadesPrefix, xadesNamespace, xmlSignaturePrefix);
	    }
	}
    }
	...
	if (signatureProductionPlace != null) {
	    new SignatureProductionPlaceDetails(this, signatureProductionPlace, xadesPrefix, xadesNamespace, xmlSignaturePrefix);
	}
    }

    public void setSignaturePolicyIdentifier(SignaturePolicyIdentifier signaturePolicyIdentifier) {
	if (signaturePolicyIdentifier != null) {
	    new SignaturePolicyIdentifierDetails(this, signaturePolicyIdentifier, xadesPrefix, xadesNamespace, xmlSignaturePrefix);
	}
    }
}
