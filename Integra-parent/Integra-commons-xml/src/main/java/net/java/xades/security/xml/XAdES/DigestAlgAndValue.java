...
public class DigestAlgAndValue extends XAdESStructure {
    ...
    // public DigestAlgAndValue(XAdESStructure parent, OCSPResponse
    // ocspResponse)
    ...
    public DigestAlgAndValue(XAdESStructure parent, X509CRL crl, String xadesPrefix, String xadesNamespace, String xmlSignaturePrefix) throws GeneralSecurityException {
	this(parent, "DigestAlgAndValue", crl.getEncoded(), xadesPrefix, xadesNamespace, xmlSignaturePrefix);
    }

    protected DigestAlgAndValue(XAdESStructure parent, String elementName, byte[ ] data, String xadesPrefix, String xadesNamespace, String xmlSignaturePrefix) throws GeneralSecurityException {
    ...
    protected DigestAlgAndValue(XAdESStructure parent, String xadesPrefix, String xadesNamespace, String xmlSignaturePrefix) throws GeneralSecurityException {
	super(parent, "DigestAlgAndValue", xadesPrefix, xadesNamespace, xmlSignaturePrefix);
    }

    public DigestAlgAndValue(Node node, String xadesPrefix, String xadesNamespace, String xmlSignaturePrefix) {
