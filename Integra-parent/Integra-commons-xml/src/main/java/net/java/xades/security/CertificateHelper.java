...
public class CertificateHelper implements ComparableBean {
    ...
    public static void exportToPKCS7(X509Certificate certificate, OutputStream outStream) throws CertificateEncodingException, IOException {
	exportToPKCS7(certificate, outStream, true);
    }

    public static void exportToPKCS7(X509Certificate certificate, OutputStream outStream, boolean binary) throws CertificateEncodingException, IOException {
    ...
    public static X509Certificate getPKCS7Certificate(byte byteArray[]) throws CertificateException, IOException {
	ByteArrayInputStream inStream = new ByteArrayInputStream(byteArray);
	return getPKCS7Certificate(inStream);
    }

    public static X509Certificate getPKCS7Certificate(InputStream inStream) throws CertificateException, IOException {
