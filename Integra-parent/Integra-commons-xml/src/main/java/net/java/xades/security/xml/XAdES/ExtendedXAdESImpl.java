...
public class ExtendedXAdESImpl extends CompleteValidationXAdESImpl implements XAdES_X {
    ...
    public ExtendedXAdESImpl(Element baseElement, boolean readOnlyMode, String xadesPrefix, String xadesNamespace, String xmlSignaturePrefix, String digestMethod) {
