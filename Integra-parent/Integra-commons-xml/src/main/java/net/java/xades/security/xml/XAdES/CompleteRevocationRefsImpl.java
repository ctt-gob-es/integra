...
public class CompleteRevocationRefsImpl extends XAdESStructure implements CompleteRevocationRefs {
    ...
    // throw new
    // IllegalArgumentException("The CertValidationInfo can not be NULL.");
    //
    ...
    // {
    // for(XAdESRevocationStatus revocationStatus :
    // validatorResult.getXAdESRevocationStatuses())
    // {
    ...
    public CompleteRevocationRefsImpl(Node node, String xadesPrefix, String xadesNamespace, String xmlSignaturePrefix) {
	...
	if (ocspRefs == null) {
	    ...
	    if (element != null) {
		OCSPRefs refs = new OCSPRefs(element, xadesPrefix, xadesNamespace, xmlSignaturePrefix);
