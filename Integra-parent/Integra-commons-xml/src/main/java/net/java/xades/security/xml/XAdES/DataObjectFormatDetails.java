...
public class DataObjectFormatDetails extends XAdESStructure {
    ...
    public DataObjectFormatDetails(SignedDataObjectProperties signedDataObjectProperties, DataObjectFormat dataObjectFormat, String xadesPrefix, String xadesNamespace, String xmlSignaturePrefix) {
	super(signedDataObjectProperties, "DataObjectFormat", xadesPrefix, xadesNamespace, xmlSignaturePrefix);
	...
	if (objectIdentifier != null) {
	    new ObjectIdentifierDetails(this, objectIdentifier, xadesPrefix, xadesNamespace, xmlSignaturePrefix);
	}
	...
	// TODO: must ensure that there is an ObjectReference attribute,
