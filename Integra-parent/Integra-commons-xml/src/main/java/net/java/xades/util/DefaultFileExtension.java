...
public enum DefaultFileExtension implements FileExtension {
    CERTIFICATE_KEY_STORE_P12(".p12", "P12 Certificate Files"), CERTIFICATE_KEY_STORE_PFX(".pfx", "PFX Certificate Files"), CERTIFICATE_KEY_STORES("PKCS #12 Certificate Files", CERTIFICATE_KEY_STORE_P12, CERTIFICATE_KEY_STORE_PFX), CERTIFICATE_CER(".cer", "CER Certificate Files"), CERTIFICATE_CRT(".crt", "CRT Certificate Files"), CERTIFICATE_DER(".der", "DER Certificate Files"), ALL_CERTIFICATES("All Certificate Files", CERTIFICATE_CER, CERTIFICATE_CRT, CERTIFICATE_DER), CERTIFICATE_REVOCATION_LIST(".crl", "Certificate Revocation Lists", "CRL Files"), WINDOWS_SYSTEM_LIBRARY(".dll", "Windows System Library", "DLL Files"), LINUX_SYSTEM_LIBRARY(".so", "Linux System Library", "SO Files"), TXT_FILES(".txt", "Text Documents (*.txt) with UTF-8 encoding"), ALL_FILES(".*", "All files", "All Files");

    private DefaultFileExtension(String extension, String description) {
	this(extension, description, description, "*");
    }

    private DefaultFileExtension(String extension, String description, String fileFilterName) {
	this(extension, description, fileFilterName, "*");
    }

    private DefaultFileExtension(String extension, String description, String fileFilterName, String prefixFileFilterPattern) {
    ...
    private DefaultFileExtension(String description, FileExtension... exts) {
	this(description, description, Arrays.asList(exts));
    }

    private DefaultFileExtension(String description, String fileFilterName, FileExtension... exts) {
	this(description, fileFilterName, Arrays.asList(exts));
    }

    private DefaultFileExtension(String description, String fileFilterName, List<FileExtension> exts) {
	this.description = description;
	this.fileFilterName = fileFilterName;
    ...
    private static final TreeMap<String, TreeMap<String, FileExtension>> fileExtensionsMap = new TreeMap<String, TreeMap<String, FileExtension>>();
