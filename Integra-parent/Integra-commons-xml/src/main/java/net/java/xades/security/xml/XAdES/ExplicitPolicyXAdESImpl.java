...
public class ExplicitPolicyXAdESImpl extends BasicXAdESImpl implements XAdES_EPES {
    ...
    public ExplicitPolicyXAdESImpl(Element baseElement, boolean readOnlyMode, String xadesPrefix, String xadesNamespace, String xmlSignaturePrefix, String digestMethod) {
