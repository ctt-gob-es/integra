...
public class ObjectIdentifierDetails extends XAdESStructure {
    ...
    public ObjectIdentifierDetails(DataObjectFormatDetails dataObjectFormatDetails, ObjectIdentifier objectIdentifier, String xadesPrefix, String xadesNamespace, String xmlSignaturePrefix) {
	super(dataObjectFormatDetails, "ObjectIdentifier", xadesPrefix, xadesNamespace, xmlSignaturePrefix);
