...
public class Cert extends XAdESStructure {
    ...
    public Cert(XAdESStructure parent, X509Certificate cert, String xadesPrefix, String xadesNamespace, String xmlSignaturePrefix) throws GeneralSecurityException {
	...
	if (certDigest == null) {
	    ...
	    if (element != null)
		certDigest = new CertDigest(element, xadesPrefix, xadesNamespace, xmlSignaturePrefix);
	}
	...
	if (issuerSerial == null) {
	    ...
	    if (element != null)
		issuerSerial = new IssuerSerial(element, xadesPrefix, xadesNamespace, xmlSignaturePrefix);
	}
