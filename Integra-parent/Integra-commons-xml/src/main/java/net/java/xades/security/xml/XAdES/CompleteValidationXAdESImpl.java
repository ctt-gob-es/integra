...
public class CompleteValidationXAdESImpl extends TimestampXAdESImpl implements XAdES_C {
    ...
    public CompleteValidationXAdESImpl(Element baseElement, boolean readOnlyMode, String xadesPrefix, String xadesNamespace, String xmlSignaturePrefix, String digestMethod) {
