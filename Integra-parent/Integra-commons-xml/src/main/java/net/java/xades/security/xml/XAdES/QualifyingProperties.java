...
public class QualifyingProperties extends XAdESStructure {
	...
	element.setAttributeNS(XMLConstants.XMLNS_ATTRIBUTE_NS_URI, "xmlns:" + xmlSignaturePrefix, XMLSignature.XMLNS);
	element.setAttributeNS(XMLConstants.XMLNS_ATTRIBUTE_NS_URI, "xmlns:" + xadesPrefix, xadesNamespace);
    ...
    public QualifyingProperties(Node node, String xadesPrefix, String xadesNamespace, String xmlSignaturePrefix) {
